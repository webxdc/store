  ...
  return (
    <li class="w-full border rounded p-4 shadow" onClick={() => setIsExpanded(!isExpanded())}>
      <div class="flex items-center justify-between gap-2">
        ...
        {item.state === AppState.Initial && <button id="send-button" class="flex items-center justify-center justify-self-center px-2 bg-blue-500 rounded-half rounded-1/2 aspect-1 p-3" onClick={onDownload}> <div class="i-carbon-send-filled text-white"></div> </button>}
